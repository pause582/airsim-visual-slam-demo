...
class KinectPublisher:
    ...
    def CreateRGBMessage(self,img_rgb_data):
        ...
        self.msg_rgb.data = img_rgb_data
        self.msg_rgb.is_bigendian = 0
        self.msg_rgb.step = self.msg_rgb.width * 3
        return self.msg_rgb

    def CreateDMessage(self,img_depth_data):
        ...
        self.msg_d.data = img_depth_data
...
if __name__ == "__main__":
    ...
    #iottalk = iottalk_helper('publisher', ['img_rgb','img_d'], '39393900')
    iottalk = iottalk_helper('publisher', ['twin_img'], '39393900')

    while not rospy.is_shutdown():

        #b64_msg_rgb_bytes = iottalk.pull("img_rgb")
        print('downloading...')
        img_list = iottalk.pull_twin('twin_img')
        print('success!!')
        b64_msg_rgb_bytes = img_list[1]
        b64_msg_d_bytes = img_list[0]
        img_rgb_data = base64.b64decode(b64_msg_rgb_bytes.encode('ascii'))
        # b64string -> b64bytes -> plain
        #print(b64_msg_rgb_bytes)
        #b64_msg_d_bytes = iottalk.pull("img_d")
        img_d_data = base64.b64decode(b64_msg_d_bytes.encode('ascii'))
        ...
        pub.GetCurrentTime()
        msg_rgb = pub.CreateRGBMessage(img_rgb_data)
        msg_d = pub.CreateDMessage(img_d_data)
